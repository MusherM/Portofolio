...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('musher@foxmail.com')
    setCopied(true)
  }
    ...
    >
      <div className={`${id === 6 ? 'flex justify-center' : ''} h-full`}>
        ...
        <div
          ...
          } ${id === 4 && 'w-1/5 bottom-2 right-2'}`}
        >
          {spareImg && (
            <img
              src={(process.env.NEXT_PUBLIC_ASSET_PREFIX || '') + spareImg}
              alt=""
